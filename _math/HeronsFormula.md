...
This gives us a formula for $$R$$ in terms of the tangent lengths. An affine formula when $$N$$ is $$3$$ or $$4$$, a formula as the solution to a quadratic equation when $$N$$ is $$5$$ or $$6$$, etc. In jargon, we say we have a formula for the inradius of a tangential polygon in terms of its tangent lengths.
