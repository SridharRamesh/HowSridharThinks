...
Observation by Aaron David Fairbanks: "I noticed a slick proof of total colimits = empty limits you may be interested to hear. By the Yoneda lemma and that colimits in functor categories are pointwise, the colimit of the Yoneda embedding is terminal in Psh(C). The Yoneda embedding reflects limits and colimits since it is fully faithful."
...
After all, a limit is a terminal cone. Therefore, it is a total colimit of all cones, within the category of cones.
...
As another application of this observation, I can then perhaps apply this to [bottoms-up Knaster-Tarski](@/LambekKnasterTarski.md), by doing such a coequalizer of all endomorphisms at every stage.]
